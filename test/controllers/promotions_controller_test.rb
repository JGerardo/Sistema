...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { acuerdo: @promotion.acuerdo, client_id: @promotion.client_id, descripcion: @promotion.descripcion, medio: @promotion.medio, user_id: @promotion.user_id }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { acuerdo: @promotion.acuerdo, client_id: @promotion.client_id, descripcion: @promotion.descripcion, medio: @promotion.medio, user_id: @promotion.user_id }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
