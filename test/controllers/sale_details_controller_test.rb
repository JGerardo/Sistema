...
class SaleDetailsControllerTest < ActionController::TestCase
  ...
  test "should create sale_detail" do
    assert_difference('SaleDetail.count') do
      post :create, sale_detail: { book_id: @sale_detail.book_id, cantidad: @sale_detail.cantidad, descuento: @sale_detail.descuento, precio: @sale_detail.precio, sale_id: @sale_detail.sale_id, total: @sale_detail.total }
    end
  ...
  test "should update sale_detail" do
    patch :update, id: @sale_detail, sale_detail: { book_id: @sale_detail.book_id, cantidad: @sale_detail.cantidad, descuento: @sale_detail.descuento, precio: @sale_detail.precio, sale_id: @sale_detail.sale_id, total: @sale_detail.total }
    assert_redirected_to sale_detail_path(assigns(:sale_detail))
  end
